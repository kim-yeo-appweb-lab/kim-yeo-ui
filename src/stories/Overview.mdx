...
<div style={{ marginBottom: "48px" }}>
	<div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "16px" }}>
		...
		<div style={{ display: "flex", flexDirection: "column" }}>
			<h1 style={{ margin: 0, fontSize: "32px", fontWeight: 700 }}>@kim-yeo-appweb-lab/ui</h1>
			<span style={{ color: "#52525b" }}>React 19 + Tailwind CSS 4 기반 범용 UI 컴포넌트 라이브러리.</span>
			<span style={{ color: "#52525b" }}>프레임워크 독립적 설계와 확장 가능한 디자인 토큰 시스템을 제공합니다.</span>
		</div>
	</div>
</div>
